...
class I200_serial:
    ...
    def profile_internal(self, p1=0, p2=10, np=100, draw=True, verbose = 0):
    ...
    def start_measurement(self):
        ...
        while(self.currents()[2] == "OVERLOAD" and r <= self.capacitor()[1] / 1e-5):
            self.range(r)
            r = r * 10
    ...
    def tune(self, p1=1, p2=9, np=50, offset = 0.025):
	...
	if not self.mode() in [0, 1]:
		self.mode(1)
	if __mode in [0,1]:
           locked_pos=self.profile(p1 = p1, p2 = p2, np = np)[1]+offset
