...
class counter:
	def __init__(self,cpt=None,deadtime=0.01,maxRetries=5,user_readconfig=[]):
	...
	def read(self):
		"Returns tuples of counters: the number of channels in slave cards is still uncertain, in doubt: do not use the 1st one."
		try:
