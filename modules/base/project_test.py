...
def check_project(project_number=""):
    ...
    IPy=get_ipython()
    try:
        users_root = IPy.user_ns["__SPECK_CONFIG"]["USER_DATA_ROOT"]
    except:
        users_root = "."
    information = {}
    ...
    information["project"]=project_number
    ...
    information["folder"] = users_root + os.sep + "%s"%information["project"] + os.sep + "published-data"
