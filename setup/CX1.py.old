...
try:
    from p_xspress3 import xspress3_test
    #Fastosh recognized detector names:
    #CdTe, Canberra_Ge36, Canberra_Ge7, Vortex_SDD4, Vortex_SDD1, Canberra_SDD13
    detector_details={"detector_name":"Vortex_SDD4","real_pixels_list":"1,2,3,4","comment":"Vortex ME4 from pool"}

    config = {"fileGeneration":False,"streamTargetPath":'/nfs/srv5/spool1/xspress3_mini',"streamtargetfile":"x3_mca"}
    
    x3mca_test = xspress3_test("tmp/test/xspress3.1",identifier = "fluo04",timeout=90., 
    config=config,detector_details = detector_details)
    
    print(GREEN+" x3mca_test --> xspress3 mini + Vortex ME4"+RESET)
except Exception as tmp:
    print(tmp)
