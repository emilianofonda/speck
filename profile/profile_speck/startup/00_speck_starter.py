...
#Remove the following two variables from everywhere
...
__SPECK_CONFIG["USER_HOME_ROOT"] = USER_HOME_ROOT
__SPECK_CONFIG["USER_DATA_ROOT"] = USER_DATA_ROOT
__SPECK_CONFIG["SOLEIL_DATA_ROOT"] = SOLEIL_DATA_ROOT
__SPECK_CONFIG["TEMPORARY_FOLDER"] = SPECK_TEMPORARY_FOLDER
